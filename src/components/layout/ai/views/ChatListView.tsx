...
import { useJsonMessageStore, ChatSession } from '@/hooks/useJsonMessageStore';
import { 
  PlusIcon, 
  TrashIcon, 
  MagnifyingGlassIcon,
...
export const ChatListView: React.FC<ChatListViewProps> = ({
  ...
  const messageStore = useJsonMessageStore(userId);
  ...
  const filteredSessions = React.useMemo(() => {
    ...
    return messageStore.sessions.filter((session: ChatSession) => {
      // Search in title
